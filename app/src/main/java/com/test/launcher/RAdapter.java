...
public class RAdapter extends RecyclerView.Adapter<RAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            pckgname =  itemView.findViewById(R.id.pckgname);
    ...
    public RAdapter(Context c, int row, List<AppInfo> appsList) {
    ...
    public void onBindViewHolder(RAdapter.ViewHolder viewHolder, int i) {
        ...
        TextView pckgname = viewHolder.pckgname;

        ImageView imageView = viewHolder.img;


        textView.setText(appLabel);
        pckgname.setText(appPackage);
